...
## Product Walkthrough (Bilingual + Timeline)

> The walkthrough is organized as a timeline from onboarding to delivery. Each phase includes multiple screenshots so readers can quickly understand the full EvoUI testing loop.

### Phase 01 — Access & Context Setup
...
### Phase 02 — Requirement to Test Assets

#### 3. User Story 管理 / User Story Management
**中文**：支持手动维护多类 User Story（PAGE / FUNCTION / FLOW / API 等）。
**EN**: Maintain PAGE / FUNCTION / FLOW / API stories to turn requirements into executable assets.
...
**EN**: Auto-generate API scripts from API stories, then refine them through conversational iteration and preference memory.

<img width="560" alt="EvoUI API automation" src="https://github.com/user-attachments/assets/3fe2c388-cd0a-4d98-9b66-2b026486f0c5" />

### Phase 03 — Orchestrate, Execute, and Improve
...
**EN**: Visually orchestrate complex, multi-stage workflows with branch control and recovery paths.
...
**EN**: Execute UI automation with reporting and continuously improve execution stability through process memory.
...
`Login & Access → Project Context Setup → Story Curation → Case/Script Generation → Agent Orchestration → API/UI Validation & Reports → Memory Feedback Loop`
