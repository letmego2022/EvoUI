...
| 左侧视图 | 时间线节点 | 右侧视图 |
|---|---|---|
| <img width="360" alt="EvoUI 登录页" src="https://github.com/user-attachments/assets/92ac4f5c-99d4-4018-b9fc-75ffc7f4d5ab" /> | **Phase 01：进入平台**<br/>中文：登录并进入统一仪表盘，建立测试上下文。<br/>EN: Sign in and land on the dashboard to establish project context. | <img width="360" alt="EvoUI 仪表盘" src="https://github.com/user-attachments/assets/3bae5bb1-8232-4137-bb86-51d1da53826e" /> |
